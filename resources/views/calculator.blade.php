                ...
                <div>
                    <form action="calculate"  method="POST">
                        ...
                        <div class="form-group">
                            ...
                            <button type="submit" class="btn btn-secondary" name="action" value="difference">-</button>
                            <button type="submit" class="btn btn-success" name="action" value="multiply">*</button>
                            <button type="submit" class="btn btn-danger" name="action" value="divide">/</button>
                        </div>
                        <div>
